...
const targetSelector = document.getElementById("selectedTarget");
const nonARElements = document.querySelectorAll(".non-ar-element");
...
class ImageTrackingWebXR {
  ...
  async setup(scene, renderer) {
    ...
    button.addEventListener("click", () => {
        console.log("ar clicked", nonARElements)
        nonARElements.forEach((e) => {
  ...
  updateImageTrackingWebXR(
    timestamp,
    frame,
    renderer,
    navigationAreaParent,
    navigationArea
  ) {
    if (frame) {
      ...
      for (const result of results) {
        ...
        if (state == "tracked") {
          // hide and show some html content
          targetSelector.style.visibility = "initial";
          ...
          console.log(
            "Image target world position",
            imageIndex,
            markerWorldPosition
          );
          console.log(
            "Image target world rotation",
            imageIndex,
            markerWorldRotation
          );
